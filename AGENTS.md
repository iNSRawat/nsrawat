# AI Agent Guidelines for nsrawat.in

This guide provides essential information for AI agents working with the nsrawat.in codebase - a Next.js dev portfolio, blog, and component registry website.
...
- `APP_URL` - Application base URL (e.g., `https://nsrawat.in`)

**Registry Configuration**:

- `REGISTRY_NAMESPACE` - Namespace identifier for shadcn CLI (e.g., `@nsrawat`)
- `REGISTRY_NAMESPACE_URL` - URL pattern for component resolution (e.g., `https://nsrawat.in/r/{name}.json`)
